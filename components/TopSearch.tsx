...
<div onClick={onclick}  className='relative hidden group  flex-1 h-auto lg:flex flex-col  rounded-md bg-neutral-400/10 hover:bg-neutral-400/20 transition p-3'>
        <div className='relative w-full h-full rounded-md overflow-hidden'>
            <Image className='object-cover w-1/4 h-1/4 rounded' src={(imagePath)?imagePath:"/images/liked.png"} width={100} height={100} alt='song image' />
        </div>
        <div className='flex flex-col items-start w-full p-4 gap-y-3 '>
<p className='font-semibold truncate w-full text-2xl'>{data.title}</p>
<sub className=' text-sm  text-neutral-400'>Song:{data.aurthor}</sub>
